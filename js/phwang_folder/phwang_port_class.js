...
function PhwangPortClass (phwang_object_val) {
    ...
    this.receiveGetNameListResponse = function (name_list_array_val, length_val) {this.rootObject().ajaxObject().receiveGetNameListResponse(name_list_array_val, length_val);};
