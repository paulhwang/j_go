...
function ConfigHtmlObject(root_object_val) {
    ...
    this.setupHtmlInputFunction = function() {
        ...
        $(".config_section .config_button").on("click", function() {
            ...
            this0.phwangAjaxObject().setupSession1(this0.phwangLinkObject(), this0.configObject().hisName(), encoded_config);
        });
    };
...
function ConfigAjaxClass(root_object_val) {
    ...
    this.receiveSetupSession1Response = function(result_val) {/*this.htmlObject().gotoNextPage();*/};
